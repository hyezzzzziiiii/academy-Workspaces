...
public class Formatter05 {
	...
	public static void main(String[] args) throws ParseException {
		...
		msg = "INSERT INTO " + tableName + " VALUES (''{0}'', ''{1}'', {2},''{3}'');";
		...
		for(int i =0; i<data.length; i++) {
			...
			// {0} {1} {2} {3} 위치에 있는 데이터들이 분리되어 objs 배열이 나눠저장됩니다.
			// 분리되는 항목이외의 글자들 INSERT INTO CUST_INFO VALUES (~~)
			// 그텍스들이 반드시 같아야하는 조건이 있습니다.
