...
public class Joindo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 전달된 item의 갯수만큼의 크기를 갖는 goods배열 생성
		...
		if(job.equals("Ⅰ"))  request.setAttribute("job", "학생");
		else if(job.equals("Ⅱ")) request.setAttribute("job", "컴퓨터/인터넷");
		else if(job.equals("Ⅲ")) request.setAttribute("job", "언론"); 
		else if(job.equals("Ⅳ")) request.setAttribute("job", "공무원"); 
		else if(job.equals("Ⅴ")) request.setAttribute("job", "군인");
		else if(job.equals("Ⅵ")) request.setAttribute("job", "서비스업");
